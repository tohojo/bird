...
define_blake_fmt(blake2s, BLAKE2S_SIZE)
define_blake_fmt(blake2b, BLAKE2B_SIZE)
...
define_test_blake_fn(blake2s, ALG_BLAKE2S)
define_test_blake_fn(blake2b, ALG_BLAKE2B)
...
{                                               \
  ...
  return bt_assert_batch(test_vectors, test_##name,    \
                         name##_in_fmt, name##_out_fmt);        \
}
...
main(int argc, char *argv[])
{
  ...
  bt_test_suite(t_blake2s, "Testing Blake2s");
  bt_test_suite(t_blake2b, "Testing Blake2b");
